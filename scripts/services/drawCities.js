'use strict';
function DrawCities($q, xmlHandlers) {
    ...
    function drawZoomed(obj) { 
		...
		for(var i = 0; i < circles.length; i++) {
			if("#province-" + circles[i].attributes[8].nodeValue === provinceName) { 
			    //var newElement = document.createElementNS("http://www.w3.org/2000/svg", 'circle'); //Create a path in SVG's namespace
...
angular.module('mapSVG').factory('DrawCities', ['$q', 'xmlHandlers', DrawCities]);